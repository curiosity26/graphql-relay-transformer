...
import { ResourceConstants, plurality, graphqlName, toUpper, SyncResourceIDs, getBaseType } from 'graphql-transformer-common';
...
export class ResourceFactory {
  ...
  public initalizeDefaultInputForCreateMutation(
    ...
    timestamps: { readonly createdAtField?: string; readonly updatedAtField?: string },
  ): string {
